...
define('servidor', 'bocgd95vlgwscoz1xfik-mysql.services.clever-cloud.com');
define('nombredb', 'bocgd95vlgwscoz1xfik');
define('nombreuser', 'ugapurk0iqnjtozr');
define('puerto', '3306');
define('passworddb', '7TE3dHtztW221grK23pZ');
...
function conexion()
{
    ...
    try {
        $conn = new PDO('mysql:host=' . $host . ';port=' . $puertodb . '; dbname=' . $db, $user, $pwd, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
    ...
    ";
        ...
        echo "<embed src='../conexionpdo/cad.png' heigth='50' width='50'></embed><br><br><progress id='p' max='70'> <span>0</span>%</progress><br>";
